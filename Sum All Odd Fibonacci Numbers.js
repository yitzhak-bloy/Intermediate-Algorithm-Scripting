...
const sumFibs = (num) => {
  ...
  const calculationFibs = (num1, num2) => num1 + num2 <= num ? arrFibs.push(num1 + num2) && calculationFibs(num2, num1 + num2) : null;

  calculationFibs(1, 1)

  return arrFibs.filter(num => num % 2 !== 0).reduce((sum, number) => sum + number);
}
